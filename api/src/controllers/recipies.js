...
function getAllRecipes(req, res, next) {
    if (!req.query.name) {
        ...
        const apiRecipes = axios.get(`https://api.spoonacular.com/recipes/complexSearch?apiKey=83896f8176f44c5bb046724b1cc76986&number=${number}&addRecipeInformation=true`);
        ...
        let { name } = req.query
        const dbRecipes = Recipe.findAll();
        const apiRecipes = axios.get(`https://api.spoonacular.com/recipes/complexSearch?apiKey=83896f8176f44c5bb046724b1cc76986&number=${number}&addRecipeInformation=true&query=${name}`);
