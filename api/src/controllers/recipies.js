...
function getAllRecipes(req, res, next) {
    if (!req.query.name) {
        ...
        const apiRecipes = axios.get(`https://api.spoonacular.com/recipes/complexSearch?apiKey=a9cc00ffdfe0467b93e85637035973a0&number=${number}&addRecipeInformation=true`);
        ...
        let { name } = req.query
        const dbRecipes = Recipe.findAll();
        const apiRecipes = axios.get(`https://api.spoonacular.com/recipes/complexSearch?apiKey=a9cc00ffdfe0467b93e85637035973a0&number=${number}&addRecipeInformation=true&query=${name}`);
